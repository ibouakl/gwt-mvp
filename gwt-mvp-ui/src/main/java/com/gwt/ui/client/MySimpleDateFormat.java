 ...
 * <p>
 * <dt><b>Description: </b>
 * <dd>GWT does not implement any of the java.text package, so this class tries to fill the void of the missing java.text.SimpleDateFormat
 * class. This version however only supports a subset of the date and time patterns supported by its java.text counterpart. The pattern
 * symbols supported by this class are:
 * <dl>
 * <dt><b>E</b></dt>
 * <dd>Day in a week</dd>
 * <dt><b>d</b></dt>
 ...
 * <dd>am/pm</dd>
 * </dl>
 * All characters that are not recognised as a date format character are translated literally into the output string. <br/>
 * </dd>
 * <p>
 * </dl>
 * <p>
 * A simple date parsing facility has also been implemented resembling the java prototype. You can currently parse most numeric patterns but
 * no temporal literals (such as day or month names).
 * </p>
 * 
