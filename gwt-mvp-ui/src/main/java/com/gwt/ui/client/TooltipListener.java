...
public class TooltipListener implements  MouseOverHandler,MouseOutHandler{
    ...
    private static class Tooltip extends PopupPanel {
        ...
        public Tooltip(Element sender, int offsetX, int offsetY, final String text, final int delay, final String styleName) {
            super(true);
    ...
    public void onMouseOver(MouseOverEvent event) {
        ...
        tooltip = new Tooltip((Element)event.getRelativeElement(), offsetX, offsetY, text, delay, styleName);
        tooltip.show();
