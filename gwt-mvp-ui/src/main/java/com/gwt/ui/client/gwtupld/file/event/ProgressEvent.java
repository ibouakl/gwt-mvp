 ...
 **********************************************/
package com.gwt.ui.client.gwtupld.file.event;
...
public class ProgressEvent extends ProgressEventBase<ProgressHandler> {
    private static final Type<ProgressHandler> TYPE = new Type<ProgressHandler>("progress", new ProgressEvent());
    
    /**
     * Protected constructor, use
     * {@link DomEvent#fireNativeEvent(com.google.gwt.dom.client.NativeEvent, com.google.gwt.event.shared.HasHandlers)} to fire mouse out
     * events.
     */
