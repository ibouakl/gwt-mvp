 ...
 **********************************************/
package com.gwt.ui.client.gwtupld.file;
...
public class FileList implements Iterable<File> {
    ...
    /**
     * Returns the <code>index</code>th item in the collection. If <code>index</code> is greater than or equal to the number of nodes in the
     * list, this returns <code>null</code>.
     * 
     * @param index Index into the collection.
     * @return The node at the <code>index</code>th position in the <code>FileList</code>, or <code>null</code> if that is not a valid
     *         index.
     */
